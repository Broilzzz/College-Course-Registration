...
<div style="display: flex;margin-top: 20px">
    <a class="btn btn-primary" href="coursestemplate.jsp" role="button" style="width: 60px; margin-right: 600px;padding-bottom: 0; background-color: #198754; border-color: #198754">Back</a>
</div>
<%
...
<div class="login-page">
    <div class="form">
        ...
        <form class="login-form" action="${pageContext.request.contextPath}/admin_course_edit" method="post">
            <input type="text" name="course_id" placeholder="course id (which course) (cannot be changed)"/>
