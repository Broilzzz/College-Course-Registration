...
<div class="login-page">
    <div class="form">
        ...
        %>
        <p style="color: green;display: flex; justify-content: center; font-weight: bold; font-size: 20px">Logout Successful</p>
        <%
            }
        %>
        ...
        %>
        <form class="login-form" action="facultyLogin" method="post">
