...
<div style="display: flex;margin-top: 20px">
    <a class="btn btn-primary" href="faculty_homepage.jsp" role="button" style="width: 60px; margin-right: 600px;padding-bottom: 0; background-color: #198754; border-color: #198754">Back</a>
</div>
<%
...
<div class="login-page">
    <div class="form">
        ...
        <form class="login-form" action="edit_course" method="post">
